...
export class Ship {
    ...
    fireLaser(context) {
        ...
        entities.asteroids.forEach((a, ai) => {
            const dist = this.distToSegment({ x: a.x, y: a.y }, { x: this.x, y: this.y }, { x: laserXEnd, y: laserYEnd });
            if (dist < a.radius) {
        ...
        entities.aliens.forEach((al, ai) => {
            const dist = this.distToSegment({ x: al.x, y: al.y }, { x: this.x, y: this.y }, { x: laserXEnd, y: laserYEnd });
            if (dist < al.radius) {
        ...
        // Collision with Boss
        if (entities.boss) {
            const dist = this.distToSegment({ x: entities.boss.x, y: entities.boss.y }, { x: this.x, y: this.y }, { x: laserXEnd, y: laserYEnd });
